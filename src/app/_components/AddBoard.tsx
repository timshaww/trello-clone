				...
				<div className='w-[304px] p-3 bg-trello-popover outline-none flex flex-col rounded'>
					<div className='relative flex items-center justify-center'>
						...
						<X
							...
							className='absolute top-0 right-0 cursor-pointer text-trello-text-p hover:bg-trello-hover size-5 rounded'
						/>
					</div>
					<div className='w-full h-[1px] bg-trello-text-p my-3 opacity-50' />
					<div className='flex justify-center'>
						<div
							className={`rounded-sm w-[200px] h-[120px] bg-gradient-to-tl from-trello-backgrounds-${background}-from to-trello-backgrounds-${background}-to`}
						>
							<div className='m-3 grid grid-cols-3 grid-rows-1 gap-3'>
								<div className='rounded-[2px] flex flex-col bg-gray-300 p-1 h-full gap-1'>
									<div className='w-5 h-2 bg-white rounded-[1px]' />
									<div className='h-4 w-full bg-white p-1 rounded-[1px]'>
										<div className='w-6 h-2 bg-gray-300 rounded-[1px]' />
									</div>
									<div className='h-4 w-full bg-white p-1 rounded-[1px]'>
										<div className='w-4 h-2 bg-gray-300 rounded-[1px]' />
									</div>
									<div className='h-8 w-full bg-white rounded-[1px]'>
										<div className='flex flex-col rounded-[1px]'>
											<div className='bg-gray-200 opacity-75 h-4' />
											<div className='bg-white h-4 w-full p-1'>
												<div className='w-4 h-2 bg-gray-300 rounded-[1px]' />
											</div>
										</div>
									</div>
								...
								<div className='rounded-[2px] flex flex-col bg-gray-300 p-1 h-fit gap-1'>
								...
								<div className='rounded-[2px] flex flex-col bg-gray-300 p-1 h-full gap-1'>
									<div className='w-7 h-2 bg-white rounded-[1px]' />
									<div className='h-8 w-full bg-white rounded-[1px]'>
										<div className='flex flex-col rounded-[1px]'>
											<div className='bg-gray-200 opacity-75 h-4' />
											<div className='bg-white h-4 w-full p-1'>
					...
					<div>
						<button className='w-full py-1.5 px-3 bg-trello-accent rounded mt-3 text-trello-popover font-semibold text-sm'>Create</button>
					</div>
				</div>
			</PopoverContent>
		</Popover>
